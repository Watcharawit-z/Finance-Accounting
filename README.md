...
**40 หน้าจอ** ที่ทำงานจริง ออกเอกสารได้ ลงบัญชีได้ ยื่นแบบภาษีได้ ปิดงวดได้
...
```bash
node tools/flowaccount-import/test.js  # 73 ข้อ — ย้ายข้อมูลจาก FlowAccount เข้าระบบจริง
node webapp/test.js              # 127 ข้อ — เครื่องบัญชีในเบราว์เซอร์ (ไม่ต้องติดตั้งอะไร)
node webapp/uitest.js            # 151 ข้อ — หน้าเว็บจริงใน Chromium ทุกหน้าจอทุกปุ่ม
...
| `webapp/` | **ระบบที่ใช้งานได้จริงในไฟล์เดียว** 40 หน้าจอ รันในเบราว์เซอร์ ([README](webapp/README.md)) |
...
**ใน `webapp/` (ครบทุกโมดูล)** — วงจรเอกสารขายครบตั้งแต่ใบเสนอราคา → ใบสั่งขาย →
ใบกำกับภาษี → ใบเสร็จรับเงิน แปลงต่อกันได้ในปุ่มเดียวโดยยอดไม่เพี้ยน ·
ออกใบกำกับภาษีที่ตรวจครบตามมาตรา 86/4 ก่อนจองเลข ·
รับชำระพร้อมภาษีที่ลูกค้าหักไว้ · ใบลดหนี้ตามมาตรา 86/10 และใบเพิ่มหนี้ตามมาตรา 86/9 ·
ใบสั่งซื้อที่แปลงเป็นรายการตั้งหนี้ได้ · ตั้งหนี้ที่กันเลขใบกำกับซ้ำ
...
- `webapp/` ระบบครบ 40 หน้าจอ ผ่านการทดสอบ 278 ข้อ — เสร็จ
