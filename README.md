...
node webapp/test.js              # 163 ข้อ — เครื่องบัญชีในเบราว์เซอร์ (ไม่ต้องติดตั้งอะไร)
node webapp/uitest.js            # 172 ข้อ — หน้าเว็บจริงใน Chromium ทุกหน้าจอทุกปุ่ม
...
- `webapp/` ระบบครบ 40 หน้าจอ ผ่านการทดสอบ 335 ข้อ — เสร็จ
