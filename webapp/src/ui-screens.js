...
function scAbout() {
  ...
  + card({
    ...
    body: '<div class="prose">'
      ...
      + '<p class="dim">ข้อมูลในหน้านี้เป็นข้อมูลตัวอย่างที่สร้างขึ้นทั้งหมด เก็บไว้ในเบราว์เซอร์ของคุณเครื่องเดียว '
      + 'ไม่ได้ส่งออกไปที่ใด กดปุ่มด้านล่างเพื่อล้างและเริ่มใหม่</p></div>',
    foot: btn('reset', 'ล้างข้อมูลและเริ่มใหม่'),
  });
}
